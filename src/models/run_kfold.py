r"""Drive the k-fold sweep: 4 configurations x 5 folds, one run after another.
    ...
    python src/models/run_kfold.py --list           # the four cells and their flags
...
This driver decides nothing. The four cells and their flags are fixed in
CONFIGS below -- `--list` prints them.
...
def main():
    ...
    ap.add_argument("--list", action="store_true", help="print the four cells and their flags")
    ...
    print("\nNext: python src/eval/recompute_eval_all.py")
