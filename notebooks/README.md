...
| infer | [`MSN_inference.ipynb`](MSN_inference.ipynb) | Loads one fold's checkpoint and completes a defective skull: 4096 points in, 6144 out | GPU + that fold's checkpoint ([download](../README.md#checkpoints)). About a second per skull |
...
them in `MSN_eval_metrics.ipynb`.
...
- Trained checkpoints: [`README.md`](../README.md#checkpoints)
